...
grep -Fxq 'https://mirror.51343.ru/openwrt/releases/25.12.5/targets/rockchip/armv8/packages/packages.adb' "$distfeeds" ||
  fail_test "transaction did not normalize an OpenWrt 25 target feed"
grep -Fxq 'https://mirror.51343.ru/openwrt/releases/25.12.5/packages/aarch64_generic/video/packages.adb' "$distfeeds" ||
